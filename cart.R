...
cart_muld40msl8 = read.csv("cart_max840.csv")
plot(dpp[,1],cart_muld40msl8[,1], xlab = "MÄND", ylab = "CART: msl=8, max.depth=40", xlim = c(0,1), ylim = c(0,1))
plot(dpp[,2],cart_muld40msl8[,2], xlab = "KUUSK", ylab = "CART: msl=8, max.depth=40", xlim = c(0,1), ylim = c(0,1))
plot(dpp[,3],cart_muld40msl8[,3], xlab = "KASK", ylab = "CART: msl=8, max.depth=40", xlim = c(0,1), ylim = c(0,1))
plot(dpp[,4],cart_muld40msl8[,4], xlab = "MUU", ylab = "CART: msl=8, max.depth=40", xlim = c(0,1), ylim = c(0,1))

sqrt(mean((dpp[,1] - cart_muld40msl8[,1])**2))
sqrt(mean((dpp[,2] - cart_muld40msl8[,2])**2))
sqrt(mean((dpp[,3] - cart_muld40msl8[,3])**2))
sqrt(mean((dpp[,4] - cart_muld40msl8[,4])**2))
